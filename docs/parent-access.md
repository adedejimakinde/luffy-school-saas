...
| A7 students sit exams on their credential | D2, D3, D5, D6, D7, D8, D9, D10, D11, and D1 on its other three bullets | D4's entire reason for a separate mechanism, and D1's exam-credential bullet. D3 is untouched — a verified channel plus a one-time code does not depend on exams existing — so what falls is the case for a *second* mechanism, not the shape of the first |
